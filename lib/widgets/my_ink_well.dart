...
/// 加入了防止双击的时间控制，默认1秒
class MyInkWell extends _InkResponse {
  /// Creates an ink well.
  ///
...
class _InkResponse extends StatelessWidget {
    ...
    implements _ParentInkResponseState
{
  ...
  void handleTap() {
    var duration = widget.duration ?? const Duration(milliseconds: 1000);
    var currentTime = DateTime.now().millisecondsSinceEpoch;
    if (currentTime - _time < duration.inMilliseconds){
      return;
    }
    _time = currentTime;
