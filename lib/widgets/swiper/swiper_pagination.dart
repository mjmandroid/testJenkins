...
class RectSwiperPaginationBuilder extends SwiperPlugin {
  const RectSwiperPaginationBuilder({this.activeColor, this.color, this.key, this.size = const Size(10.0, 2.0), this.activeSize = const Size(10.0, 2.0), this.space = 3.0});
...
class SwiperPagination extends SwiperPlugin {
  const SwiperPagination({this.alignment, this.key, this.margin = const EdgeInsets.all(10.0), this.builder = SwiperPagination.dots});
  ...
  @override
  Widget build(BuildContext context, SwiperPluginConfig config) {
    final defaultAlignment = config.scrollDirection == Axis.horizontal ? Alignment.bottomCenter : Alignment.centerRight;
